    ...
    const BlogLinkItems = [
        {
            ...
            subTitle: '인슈어테크 스타트업 ‘직토’가 음지의 영역에 머물러 온 전당포 사업에 인공지능(AI)과 블록체인 ...',
            image: `${image_blog_pc_1}`,
            link: 'https://ulmaya.zikto.com/page/news/%EB%8D%94%EB%B2%A8-%EC%8B%A0%EA%B0%9C%EB%85%90%EB%8C%80%EC%B6%9C%EC%84%9C%EB%B9%84%EC%8A%A4/',
        },
        {
            title: '얼마야 서비스 OPEN BETA',
            subTitle: '얼마야는 소액담보대출 ㈜직토의 자회사 핀테크 스타트업으로, 연간 1조 2000억원 시장인 국내 ...',
            image: `${image_blog_pc_2}`,
            link: 'https://ulmaya.zikto.com/page/notice/%EC%96%BC%EB%A7%88%EC%95%BC-%EC%98%A4%ED%94%88-%EB%B2%A0%ED%83%80/',
        },
        {
            title: 'AI,블록체인 기반 디지털 전당포',
            subTitle: '얼마야는 IT기술로 기존 동산담보대출산업을 새롭게 혁신하고자 합니다.',
            image: `${image_blog_pc_3}`,
            link: 'https://ulmaya.zikto.com/page/notice/AI,%EB%B8%94%EB%A1%9D%EC%B2%B4%EC%9D%B8-%EA%B8%B0%EB%B0%98-%EB%94%94%EC%A7%80%ED%84%B8-%EC%A0%84%EB%8B%B9%ED%8F%AC/',
        },
        {
            title: 'FAQ - 물품 배송 가이드',
            subTitle: '안녕하세요 ‘얼마야’ 팀 입니다.',
            image: `${image_blog_pc_4}`,
            link: 'https://ulmaya.zikto.com/page/faq/FAQ-%EB%AC%BC%ED%92%88%EB%B0%B0%EC%86%A1%EA%B0%80%EC%9D%B4%EB%93%9C/',
        },
        {
            title: 'FAQ - 보안 & 대출',
            subTitle: '안녕하세요 ‘얼마야’ 팀 입니다.',
            image: `${image_blog_pc_5}`,
            link: 'https://ulmaya.zikto.com/page/faq/FAQ-%EB%B3%B4%EC%95%88%EB%8C%80%EC%B6%9C/',
        },
        {
            title: 'FAQ - 기타',
            subTitle: 'Q: 얼마야의 감정평가 기준을 알려주세요. 얼마야에서 물품(동산)에 대한 감정평가는 2단계로 ...',
            ...
            <main>
                <HomeMainContainer>
                    <FirstArticleWrap>
                        ...
                        <LinkButtonWrap>
                            <LinkContainer
                                href="https://apps.apple.com/kr/app/%EC%96%BC%EB%A7%88%EC%95%BC/id1479169245"
                            >
                                <img
                                    alt="app store link"
                                    src={app_store}
                            ...
                            <LinkContainer
                                href="https://play.google.com/store/apps/details?id=com.zikto.howmuch"
                ...
                <HomeArticleContainer>
                    <ThirdArticleWrap>
                        <BlogContainer>
                        <SubTitleTextThird>
                            얼마야 블로그에서 서비스의<br/>자세한 공지를 확인 해주세요.
                        </SubTitleTextThird>
                        <div style={{width: 180, height: 54, borderRadius: 27, backgroundColor: '#00EEB6', fontWeight: 'bold', fontSize: 20,  color: 'white'}}>
                            <BlogLinkContainer
                                href="https://ulmaya.zikto.com/page/"
                            >
                                얼마야 블로그
                            </BlogLinkContainer>
                        </div>
