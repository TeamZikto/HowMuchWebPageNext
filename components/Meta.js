...
const Meta = ({ data }) => {
    ...
    const keywords = `중고거래, 중고매입, 담보대출, 소액대출, 휴대폰 판매, 노트북 판매, ${data.keywords}`;
    const image = data.image !== undefined && `${data.image}`;
    const canonical = `https://ulmaya.zikto.com/${data.canonical}`;
    ...
    return (
        ...
        <>
            ...
            <meta name="twitter:site" content="https://ulmaya.zikto.com" />
            {canonical ? (
